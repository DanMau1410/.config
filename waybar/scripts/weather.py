...
# like this: https://weather.com/en-IN/weather/today/l/location_id
# once you get the location_id, you can replace the below location_id with your own location_id
location_id = "a0ec7f05350c32fe86db89502274be7d3438ca98145c895c88f3ef6502f209cc"  # TODO
...
#print(status_code_class)
status_code = str(status).split("/")[0]#.split("-")[1]
#print(status_code)
